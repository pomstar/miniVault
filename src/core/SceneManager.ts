...
export default class SceneManager {
	...
	private constructor() {
        ...
        //     // this.app.renderer.resize(vv);
        //     // this.app.stage.scale.x = window.innerWidth / this.gameSettings.gameWidth;
        //     // this.app.stage.scale.y = window.innerHeight / this.gameSettings.gameHeight;
        // });
	}
